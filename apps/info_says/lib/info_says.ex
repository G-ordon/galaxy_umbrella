defmodule InfoSays do
  @moduledoc """
  Documentation for `InfoSays`.
  """
  ...
  """
  alias InfoSays.Cache  # Corrected alias

  @backends [InfoSays.Wolfram]
  ...
  defp async_query(backend, query, opts) do
    Task.Supervisor.async_nolink(InfoSays.TaskSupervisor,
      backend, :compute, [query, opts],
